...
const Reservation = () => {
    ...
    const [selectedValue, setSelectedValue] = useState("حرف پلاک");
    ...
    return (
        <div>
                ...
                <div className={styles.formFields}>
                    ...
                    <div className={styles.carNumber}>
                        ...
                        <Select
                            ...
                            value={word.find(obj => obj.value === selectedValue)} // set selected value
            ...
            {reserveIsDone && <p><p style={{ "direction": "rtl" }}>محل پارکی برای خوردو به شماره
                (ایران{data.num3}){data.num2}{selectedValue}{data.num1}
                &nbsp;برای ساعت {data.time}&nbsp;درنظر گرفته شد.</p>
